...
describe('Datetime', () => {
    ...
    it('viewMode=days: renders days, week days, month, year', () => {
        ...
        oldDatesIndexes.forEach(index => {
            expect(
                utils.getNthDay(component, index).hasClass('rdtOld')
            ).toBeTruthy();
        });
        ...
        for (let i = 6; i < 37; i++) {
            expect(
                utils.getNthDay(component, i).hasClass('rdtDay')
            ).toBeTruthy();
            expect(
                utils.getNthDay(component, i).hasClass('rdtOld')
            ).toBeFalsy();
            expect(
                utils.getNthDay(component, i).hasClass('rdtNew')
            ).toBeFalsy();
        }
        ...
        nextDatesIndexes.forEach(index => {
            expect(
                utils.getNthDay(component, index).hasClass('rdtNew')
            ).toBeTruthy();
        });
    });
    ...
    it('sets CSS class on selected item (day)', () => {
        ...
        expect(
            utils.getNthDay(component, 13).hasClass('rdtActive')
        ).toBeTruthy();
    });
    ...
    it('sets CSS class on selected item (month)', () => {
        ...
        expect(
            utils.getNthMonth(component, 4).hasClass('rdtActive')
        ).toBeTruthy();
    });
    ...
    it('sets CSS class on selected item (year)', () => {
        ...
        expect(
            utils.getNthYear(component, 3).hasClass('rdtActive')
        ).toBeTruthy();
    });
    ...
    it('selected day persists (in UI) when navigating to prev month', () => {
        ...
        utils.openDatepicker(component);
        expect(
            utils.getNthDay(component, 8).hasClass('rdtActive')
        ).toBeTruthy();
        // Go to previous month
        utils.clickOnElement(component.find('.rdtDays .rdtPrev span'));
        expect(
            utils.getNthDay(component, 36).hasClass('rdtActive')
        ).toBeTruthy();
    });
    ...
    it('sets CSS class on today date', () => {
        ...
        // Mock the today date
        MockDate.set(specificDate.toDate());
    ...
    describe('with custom props', () => {
        ...
        it('strictParsing=false', done => {
            const date = new Date(2000, 0, 15, 2, 2, 2, 2),
                ...
                component = utils.createDatetime({
                    ...
                    strictParsing: false,
                    onChange: updated => {
                        expect(mDate.format('L LT')).toEqual(
                            updated.format('L LT')
                        );
                        done();
                    }
        ...
        it('isValidDate -> disable months', () => {
            ...
            expect(
                utils.getNthMonth(component, 0).hasClass('rdtDisabled')
            ).toEqual(false);
            expect(
                utils.getNthMonth(component, 4).hasClass('rdtDisabled')
            ).toEqual(false);
            expect(
                utils.getNthMonth(component, 5).hasClass('rdtDisabled')
            ).toEqual(true);
            expect(
                utils.getNthMonth(component, 11).hasClass('rdtDisabled')
            ).toEqual(true);
        });
        ...
        it('isValidDate -> disable years', () => {
            ...
            expect(
                utils.getNthYear(component, 0).hasClass('rdtDisabled')
            ).toEqual(false);
            expect(
                utils.getNthYear(component, 6).hasClass('rdtDisabled')
            ).toEqual(false);
            expect(
                utils.getNthYear(component, 7).hasClass('rdtDisabled')
            ).toEqual(true);
        });
    ...
    describe('with set value', () => {
        ...
        it('UTC value from local moment', () => {
            const date = new Date(2000, 0, 15, 2, 2, 2, 2),
                ...
                strDateUTC =
                    momentDateUTC.format('L') +
                    ' ' +
                    momentDateUTC.format('LT'),
                component = utils.createDatetime({
                    value: momentDate,
                    utc: true
                });
